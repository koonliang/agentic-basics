...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): Config {
  ...
  return {
    ...
    credentialProviderName: env.GATEWAY_API_KEY_PROVIDER_NAME?.trim() || "agentic-basics-lab11-gateway",
    ...
    role,
    runtimeUserId: env.AGENT_RUNTIME_USER_ID?.trim() || "lab11-demo-user",
