output "document_bucket" {
  description = "S3 bucket used for source PDFs."
  value       = aws_s3_bucket.documents.bucket
}

output "multimodal_bucket" {
  description = "S3 bucket used for extracted multimodal content."
  value       = aws_s3_bucket.multimodal.bucket
}
